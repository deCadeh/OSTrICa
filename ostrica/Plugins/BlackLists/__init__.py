...
class BlackListChecker:
    ...
    def emerging_threats(self):
        ...
        hhandle = httplib.HTTPSConnection(self.emerging_threats_host, timeout=cfg.timeout)
    ...
    def alienvault(self):
        ...
        hhandle = httplib.HTTPSConnection(self.alienvault_host, timeout=cfg.timeout)
        hhandle.putrequest('GET', query)
        hhandle.putheader('Connection', 'keep-alive')
        hhandle.putheader('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8')
        hhandle.putheader('Accept-Encoding', 'gzip, deflate, sdch')
    ...
    def tor_exit_nodes(self):
        ...
        hhandle = httplib.HTTPSConnection(self.tor_nodes_host, timeout=cfg.timeout)
        hhandle.putrequest('GET', query)
        hhandle.putheader('Connection', 'keep-alive')
        hhandle.putheader('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8')
        hhandle.putheader('Accept-Encoding', 'gzip, deflate, sdch')
    ...
    def bambenekconsulting_feed(self):
        ...
        hhandle = httplib.HTTPSConnection(self.bambenekconsulting, timeout=cfg.timeout)
        hhandle.putrequest('GET', query)
        hhandle.putheader('Connection', 'keep-alive')
        hhandle.putheader('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8')
        hhandle.putheader('Accept-Encoding', 'gzip, deflate, sdch')
